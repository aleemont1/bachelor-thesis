...
Le evidenze sperimentali ottenute hanno validato la scelta architetturale del sistema radio,
consentendo di procedere con lo sviluppo del protocollo di comunicazione e della logica
di trasmissione, assumendo una robusta copertura anche in scenari outdoor complessi.
\subsubsection{Disallineamento angolare dell'antenna direzionale}
\begin{table}[H]
    \centering
...
sono riportati in appendice~\ref{test:segmentation}. Il sistema ha dimostrato di essere
in grado di gestire correttamente il riassemblaggio dei \emph{payload} segmentati, con
