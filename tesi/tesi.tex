...
Le ragioni che hanno portato alla scelta di \ac{LoRa} per il sistema di telemetria
di Borealis sono molteplici.
...
I test effettuati in laboratorio hanno ulteriormente confermato la capacità del 
modulo E220 di soddisfare i requisiti di trasmissione dati del sistema di 
telemetria.
