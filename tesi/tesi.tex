...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/telemetry_test_direct.png}
    \caption{Test di disallineamento angolare dell'antenna direzionale.}
    \label{fig:directional-test}
\end{figure}
I risultati sono riportati nella Tabella \ref{tab:signal-strength-directional}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/telemetry_test_omni.png}
    \caption{Test di disallineamento angolare dell'antenna omnidirezionale.}
    \label{fig:omnidirectional-test}
\end{figure}
I risultati sono riportati nella Tabella \ref{tab:signal-strength-omni}.
...
\begin{table}[H]
    ...
    \resizebox{0.9\textwidth}{!}{
        \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
            \hline
            \textbf{Distance (m)} & \textbf{0°} & \textbf{5°} & \textbf{10°} & \textbf{15°} & \textbf{20°} & \textbf{25°} & \textbf{30°} & \textbf{90°} \\
            \hline
            \textbf{100}          & 80.00       & 78.43       & 77.65        & 78.43        & 80.39        & 82.35        & 82.35        & 84.31        \\
            \textbf{250}          & 76.47       & 79.61       & 79.61        & 78.43        & 78.43        & 78.82        & 78.82        & 82.35        \\
            \textbf{780}          & 73.73       & 72.55       & 69.80        & 72.55        & 72.94        & 73.73        & 71.37        & 76.47        \\
            \textbf{1000}         & 66.27       & 67.84       & 66.67        & 68.24        & 67.06        & 68.63        & 68.24        & 68.63        \\
            \textbf{1500}         & 62.75       & 62.75       & 63.14        & 62.75        & 62.35        & 62.35        & 62.35        & 64.71        \\
            \textbf{2000}         & 63.14       & 63.14       & 63.14        & 63.14        & 63.14        & 63.14        & 63.14        & 63.14        \\
            \hline
        \end{tabular}
    }
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{img/antenna-misalignement.png}
