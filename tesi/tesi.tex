...
\ifdefined\HCode
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|}
            ...
            10m               & +17 dBm                      & Dimensione del payload          \\ \hline
            50m               &                              &                                 \\ \hline
            100m              &                              &                                 \\ \hline
            500m              &                              &                                 \\ \hline
        \end{tabular}
...
\ifdefined\HCode
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|}
            \hline
            \textbf{Distanza} & \textbf{Potenza trasmissiva} & \textbf{Variabili di controllo} \\ \hline
            5m                & +17 dBm                      & Durata di trasmissione          \\ \hline
...
\sidenote{Da aggiungere il test di robustezza in condizioni di rumore e interferenze, con un grafico che mostra l'andamento del \ac{RSSI} durante la trasmissione.}
\section{Confronto tra simulazioni e risultati sul campo}
\sidenote{Forse da rimuovere}
