...
una libreria open-source\libref{lib:lora} per la comunicazione \ac{LoRa} e
un protocollo di comunicazione personalizzato\sidenote{Da descrivere} per la
...
Il sistema di telemetria di Borealis impiega il modulo \ac{LoRa}
\emph{EByte E220-900T22D}, il quale integra la ricetrasmittente \ac{LoRa}
\emph{Smart Home LLCC68}. Questo modulo è progettato per operare nella banda
di frequenza compresa tra 850.15 MHz e 930.15 MHz.
Il modulo può trasmettere con una potenza massima di +22 dBm (160 mW). 
...
inviato) è configurabile nell’intervallo SF5 – SF12, influenzando il data rate, 
che può variare tra 0.3 kbps e 62.5 kbps.
