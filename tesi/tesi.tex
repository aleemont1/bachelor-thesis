...
\ifdefined\HCode
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|}
            \hline
            \textbf{Distanza} & \textbf{RSSI [\%] Media} & \textbf{RSSI [\%] $\sigma$} & \textbf{RSSI [\%] Min} & \textbf{RSSI [\%] Max} & \textbf{Throughput [Byte/s] Media} & \textbf{Throughput [Byte/s] $\sigma$} & \textbf{Throughput [Byte/s] Min} & \textbf{Throughput [Byte/s] Max} & \textbf{Pkt/s Media} & \textbf{Pkt/s $\sigma$} \\        \hline
