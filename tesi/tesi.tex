...
in fibra di carbonio, divisa in \emph{Electronics bay} e \emph{Parachute tube}, 
e un \emph{nose cone} per l'aerodinamica e l'espulsione del paracadute. \\
\begin{figure}[H]
    \centering
...
\section{Panoramica della tecnologia LoRa.}
\cite{Andrade2022}
